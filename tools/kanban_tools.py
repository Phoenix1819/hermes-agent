...
def _maybe_append_opportunistic_flag(conn, task_id: str, run) -> None:
    """Append a self-assessment comment if any threshold is crossed.
    ...
    try:
        ...
        logger.exception("opportunistic flagging: failed to add comment")
...
def _handle_complete(args: dict, **kw) -> str:
    ...
    try:
        ...
        try:
            ...
            _maybe_append_opportunistic_flag(conn, tid, run)
